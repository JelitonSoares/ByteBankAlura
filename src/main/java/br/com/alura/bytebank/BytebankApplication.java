...
public class BytebankApplication {
    ...
    private static void realizarTransferencia() {
        ...
        Integer numeroContaOrigen = teclado.nextInt();
        ...
        service.realizarTransferencia(numeroContaOrigen, numeroContaDestino, valor);
    ...
    private static void excluirConta() {
        System.out.println("Digite o número da conta inativa: ");
        Integer numeroConta = teclado.nextInt();

        service.excluir(numeroConta);
